    ...
    public static class GlobalEntityUtil {
        ...
        public static Entity getEntityByUUID(LevelAccessor world, String uuid) {
            try {
                ...
                ChangedExtensionMod.LOGGER.error(e.getMessage()); // Log the exception for debugging purposes
                return null;
            }
        }
        ...
        public static Entity getEntityByName(LevelAccessor world, String name) {
            try {
                ...
                ChangedExtensionMod.LOGGER.error("Error getting entity by name: " + e.getMessage());
                return null;
            }
        }
