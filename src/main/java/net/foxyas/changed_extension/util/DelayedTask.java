package net.foxyas.changed_extension.util;
...
public class DelayedTask {
    ...
    public void pause() {
        this.paused = true;
        ChangedExtensionMod.LOGGER.info("DelayedTask with ID: {} was paused by an external code", id);
    }
    ...
    public void resume() {
        this.paused = false;
        ChangedExtensionMod.LOGGER.info("DelayedTask with ID: {} was resumed by an external code", id);
    }
